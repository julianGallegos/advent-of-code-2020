...
require_relative 'count_valid_passwords'

describe CountValidPasswords do
  describe '#number_of_valid_passwords' do
    let(:count_valid_passwords) { CountValidPasswords.new(passwords) }
    ...
    describe 'sample input' do
      ...
      it 'returns the total count of valid passwords' do
        expect(count_valid_passwords.number_of_valid_passwords).to eq(2)
      end
    end

    describe 'advent of code puzzle input' do
      let(:passwords) do
        [
      ...
      it 'returns to solution for the day' do
        expect(count_valid_passwords.number_of_valid_passwords).to eq(582)
      end
    end
  end
end
